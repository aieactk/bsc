...
<div class="ui grid container">
    ...
    <div class="ui six wide column">
        ...
        <a href="https://plus.google.com/share?url={{ /*$_SERVER['HTTP_HOST']*/ "http://blessingsupplychain.sevenz-consultant.com" . $_SERVER['REQUEST_URI'] }}" onclick="javascript:window.open(this.href,
...
return false;">
        ...
        <a href="/edit-project/{{$detProject->_id}}">
            <button class="ui circular positive list icon button" id="del-btn">
                <i class="list icon"></i>
                Edit Project
            </button>
        </a>
